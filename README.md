# Lab 5 - Movies app displaying box office and top rental DVDs using [The Movie Database API](http://docs.themoviedb.apiary.io/#).
...
<img src='https://i.imgur.com/2YFfFF4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
